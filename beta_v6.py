...
def combine_write_to_csv(artifact_name, rolls_1, level_1, rolls_2, level_2, sans, goblet, circlet, EM, threshold, nuance=0):
    ...
    if nuance:
        ...
        a = ""
    if EM:
        file_name = "calcs\\" + artifact_name + a + "V_6.2" + ".csv"
    else:
        file_name = "calcs\\" + artifact_name + a + "V_6.2" + ".csv"
...
update_stat_values('EmblemOfSeveredFate', 0)
print(get_4_stat_chance(['atk_',  'enerRech_', 'eleMas'], 'critDMG_'))
p()